...
env=environ.Env(DJANGO_DEBUG=(bool,True),DJANGO_ALLOWED_HOSTS=(list,["localhost","127.0.0.1","0.0.0.0"]),POSTGRES_DB=(str,"babyblog"),POSTGRES_USER=(str,"babyblog"),POSTGRES_PASSWORD=(str,"babyblog_secret"),POSTGRES_HOST=(str,"db"),POSTGRES_PORT=(int,5432),REDIS_URL=(str,"redis://redis:6379/0"),EMAIL_HOST=(str,"mailhog"),EMAIL_PORT=(int,1025),EMAIL_USE_TLS=(bool,False),DEFAULT_FROM_EMAIL=(str,"noreply@babyblog.local"),MAX_IMAGE_SIZE_MB=(int,10),MAX_VIDEO_SIZE_MB=(int,200),MAX_DOCUMENT_SIZE_MB=(int,50))
env_file=BASE_DIR.parent/".env"
if env_file.exists(): environ.Env.read_env(str(env_file))
...
INSTALLED_APPS=["django.contrib.admin","django.contrib.auth","django.contrib.contenttypes","django.contrib.sessions","django.contrib.messages","django.contrib.staticfiles","django.contrib.postgres","rest_framework","crispy_forms","crispy_bootstrap5","django_celery_beat","django_cleanup.apps.CleanupConfig","users.apps.UsersConfig","posts.apps.PostsConfig","media_app.apps.MediaAppConfig","pregnancy.apps.PregnancyConfig","hospitals.apps.HospitalsConfig","chat.apps.ChatConfig","admin_panel.apps.AdminPanelConfig","search_app.apps.SearchAppConfig"]
MIDDLEWARE=["django.middleware.security.SecurityMiddleware","django.contrib.sessions.middleware.SessionMiddleware","django.middleware.locale.LocaleMiddleware","django.middleware.common.CommonMiddleware","django.middleware.csrf.CsrfViewMiddleware","django.contrib.auth.middleware.AuthenticationMiddleware","django.contrib.messages.middleware.MessageMiddleware","django.middleware.clickjacking.XFrameOptionsMiddleware"]
ROOT_URLCONF="babyblog.urls"
TEMPLATES=[{"BACKEND":"django.template.backends.django.DjangoTemplates","DIRS":[BASE_DIR/"templates"],"APP_DIRS":True,"OPTIONS":{"context_processors":["django.template.context_processors.debug","django.template.context_processors.request","django.contrib.auth.context_processors.auth","django.contrib.messages.context_processors.messages","admin_panel.context_processors.site_settings"]}}]
...
REST_FRAMEWORK={"DEFAULT_AUTHENTICATION_CLASSES":["rest_framework.authentication.SessionAuthentication"],"DEFAULT_PERMISSION_CLASSES":["rest_framework.permissions.IsAuthenticated"],"DEFAULT_PAGINATION_CLASS":"rest_framework.pagination.PageNumberPagination","PAGE_SIZE":20}
