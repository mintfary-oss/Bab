...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='post',
            name='media_files',
            field=models.ManyToManyField(blank=True, related_name='posts', to='media_app.mediafile'),
        ),
        migrations.AddField(
            model_name='post',
            name='pregnancy',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='pregnancy.pregnancy'),
        ),
        migrations.AddField(
            model_name='like',
            name='post',
